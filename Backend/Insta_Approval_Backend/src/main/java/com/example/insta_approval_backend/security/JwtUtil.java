...
public class JwtUtil {
    ...
    // generate token with role, adminRole, and userId
    public String generateToken(String email, String role, String adminRole, Long userId) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("role", role);
        claims.put("userId", userId); // Add user ID for ownership checks
    ...
    public String generateToken(String email, String role, Long userId) {
        return generateToken(email, role, null, userId);
    }
